package com.example.john.testeventapp;
...
public class Home extends ListActivity {
    ...
    private static final String READ_COMMENTS_URL = "http://192.168.1.14:80/webservice/events.php";
    ...
    private void updateList() {
        ...
        ListAdapter adapter = new SimpleAdapter(this, mCommentList,
                R.layout.single_event, new String[] { TAG_TITLE, TAG_MESSAGE,
